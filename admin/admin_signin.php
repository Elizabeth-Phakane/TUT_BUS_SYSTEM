...
<body class="templatemo-bg-gray">
	<div class="container">
		<div class="col-md-12">
			<h1 class="margin-bottom-15"> Admin SignIn</h1>
			<form class="form-horizontal templatemo-container templatemo-login-form-1 margin-bottom-30" role="form" action="admin_signin.php" method="post" enctype="multipart/form-data">
		        <div class="form-group">
		          <div class="col-xs-12">
		            <div class="control-wrapper">
		            	<label for="username" class="control-label fa-label"><i class="fa fa-user fa-medium"></i></label>
		            	<input name="admin_password" type="text" class="form-control" id="username" placeholder="Username"
                  value="<?php
  ...
  if (isset($_POST['submit']))
  {
    ...
    if (!preg_match("/^[0-9]+$/",$username))
    {
      $_SESSION['message'] = "No characters allowed only numeric digits ";
       $_SESSION['msg_type'] = "danger";
        ...
        $_SESSION['admin_password']=$username;
  ...
  else
    {
              ...
              $_SESSION['gender'] = $data['ad_gender'];
